//Andar
moveh = -InputCheck(INPUT_VERB.LEFT) + InputCheck(INPUT_VERB.RIGHT);
movev = -InputCheck(INPUT_VERB.UP) + InputCheck(INPUT_VERB.DOWN);

hsp=moveh*spd
vsp=movev*spd

//stop movement when text appears on screen
if (room == 4 || room == 10) {
...
if (text1 == false && text2==false){
	if InputPressed(INPUT_VERB.CHANGE){
		choice += 1
